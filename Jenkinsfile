pipeline {
    ...
    parameters {
        ...
        credentials(name: 'JK_SSH_CREDENTIAL', description: 'SSH Jenkins Private Key', defaultValue: 'TagworkJenkinsPrivateKey', credentialType: "Any", required: true )

        credentials(name: 'JK_GIT_CREDENTIAL', description: 'GIT Repository Credentials', defaultValue: 'gitea-token', credentialType: "Any", required: true )
